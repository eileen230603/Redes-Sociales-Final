...
return new class extends Migration {
    public function up(): void {
        Schema::create('mega_evento_participantes_externos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('integrante_externo_id'); // integrantes_externos.user_id
            ...
            $table->foreign('integrante_externo_id')->references('user_id')->on('integrantes_externos')->cascadeOnDelete();
        });
    }
