...
<body>
    ...
    <script>
        ...
        const IMAGE_BASE_URL = 'http://10.114.190.52:8000';
        ...
        @php
            ...
            if (strpos($bannerImg, 'http://') !== 0 && strpos($bannerImg, 'https://') !== 0) {
                if (strpos($bannerImg, '/storage/') === 0) {
                    $bannerUrl = 'http://10.114.190.52:8000' . $bannerImg;
                } elseif (strpos($bannerImg, 'storage/') === 0) {
                    $bannerUrl = 'http://10.114.190.52:8000/storage/' . $bannerImg;
                } else {
                    $bannerUrl = 'http://10.114.190.52:8000/storage/' . ltrim($bannerImg, '/');
                }
            }
        @endphp
