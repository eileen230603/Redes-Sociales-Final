...
if (typeof window.API_BASE_URL === 'undefined') {
    window.API_BASE_URL = "http://10.26.0.215:8000";
}
...
if (typeof window.PUBLIC_BASE_URL === 'undefined') {
    window.PUBLIC_BASE_URL = "http://10.26.0.215:8000"; // Valor por defecto
}

// Alias para compatibilidad con código existente - hacerlo global
if (typeof API_BASE_URL === 'undefined') {
    window.API_BASE_URL = window.API_BASE_URL || "http://10.26.0.215:8000";
...
console.log("✅ Config cargado - IP: 10.26.0.215");

// Función helper para obtener la URL pública (para QR y enlaces compartidos)
function getPublicUrl(path = '') {
    const baseUrl = window.PUBLIC_BASE_URL || "http://10.26.0.215:8000";
