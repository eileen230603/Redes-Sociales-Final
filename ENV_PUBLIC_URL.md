...
```env
PUBLIC_APP_URL=http://192.168.0.6:8000
```

## Instrucciones:

1. Abre tu archivo `.env` en la raíz del proyecto
2. Agrega la línea: `PUBLIC_APP_URL=http://192.168.0.6:8000`
...
- Si no defines `PUBLIC_APP_URL` en el `.env`, se usará el valor por defecto: `http://192.168.0.6:8000`
