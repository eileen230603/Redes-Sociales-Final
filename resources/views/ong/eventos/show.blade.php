...
<div class="container-fluid px-0">
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-end mb-4 flex-wrap" style="gap: 0.5rem;">
            ...
            <button id="btnControlAsistencia" class="btn btn-info" onclick="abrirGestionParticipantes()" style="display: none;">
                <i class="fas fa-clipboard-check mr-2"></i> Control de Asistencias
            </button>
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-sm btn-secondary btn-actualizar-participantes" onclick="cargarParticipantesCardONG()">
                            <i class="fas fa-sync mr-1"></i> Actualizar
                        </button>
                    </div>
                    <div class="card-body">
                        <p class="mb-3 text-muted">
                            Usuarios que se han inscrito en este evento. Incluye participantes registrados y voluntarios.
                        </p>
...
<style>
    ...
    /* Animación suave para las tarjetas de participantes */
    .participante-card {
...
function cargarComentarios() {
    ...
    participantesConComentarios.forEach((p, index) => {
        ...
        const fechaCheckin = p.fecha_registro_asistencia || p.fecha_inscripcion || 'Fecha no disponible';
